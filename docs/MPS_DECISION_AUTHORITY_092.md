...
Fluxo: submit_decision() gera a exigência de alçada; /api/mps-decision-approval-requirements/{id}/sign/ assina; approve_decision() bloqueia enquanto a exigência não estiver SATISFIED.
